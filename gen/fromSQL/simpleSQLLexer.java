...
public class simpleSQLLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"BOOLEAN_VALUE", "VARCHAR_TYPE", "CONSTRAINT", "AS", "LPAREN", "RPAREN", 
			"COMMA", "SEMICOLON", "INT_TYPE", "VARCHAR", "BOOLEAN_TYPE", "DATE_TYPE", 
			"DOUBLE_TYPE", "FLOAT_TYPE", "TEXT_TYPE", "ENUM", "DOMAIN", "TYPE", "CREATE", 
			"TABLE", "PRIMARY", "KEY", "UNIQUE", "NOT", "NULL", "TRUE", "FALSE", 
