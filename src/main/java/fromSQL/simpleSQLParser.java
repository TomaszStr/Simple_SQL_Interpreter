...
public class simpleSQLParser extends Parser {
	...
	public static final int
		...
		RULE_booleanValue = 25, RULE_domainConstraint = 26, RULE_createTypeStatement = 27, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"domainConstraint", "createTypeStatement", "typeName", "fieldDefinition", 
			"varcharType"
		};
	}
	...
	public final CreateDomainStatementContext createDomainStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 830472192L) != 0)) {
				{
				setState(232);
				domainConstraint();
				}
	...
	public final DomainConstraintContext domainConstraint() throws RecognitionException {
		...
		enterRule(_localctx, 52, RULE_domainConstraint);
		try {
			setState(255);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
